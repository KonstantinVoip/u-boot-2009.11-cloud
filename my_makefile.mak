...
#/////////////////////////////////////CPPFLAGS///////////////////////////////////
ARFLAGS = crv
CPFLAGS = $(OPT) $(DEBUG) -g  -Os -mrelocatable -fPIC -ffixed-r14 -meabi -D__KERNEL__ -DTEXT_BASE="$(TEXT_BASE)" -DRESET_VECTOR_ADDRESS=$(RESET_VEC) -fno-builtin -ffreestanding -nostdinc -isystem$(ISYSTEM) -pipe  -DCONFIG_PPC -D__powerpc__ -ffixed-r2 -Wa,-me500x2 -msoft-float -mno-string -mspe=yes -mno-spe
C_CPFLAGS = $(OPT) $(DEBUG) -g  -Os -mrelocatable -fPIC -ffixed-r14 -meabi -D__KERNEL__ -DTEXT_BASE="$(TEXT_BASE)" -DRESET_VECTOR_ADDRESS=$(RESET_VEC) -fno-builtin -ffreestanding -nostdinc -isystem$(ISYSTEM) -pipe  -DCONFIG_PPC -D__powerpc__ -ffixed-r2 -Wa,-me500x2 -msoft-float -mno-string -mspe=yes -mno-spe -Wall -Wstrict-prototypes -fno-stack-protector

#Флаг для сборки u-boot.lds похоже что собирать его не нужно
#UBOOT_LDSFLAGS = -E -g  -Os  -mrelocatable -fPIC -ffixed-r14 -meabi -D__KERNEL__ -DTEXT_BASE="$(TEXT_BASE)" -DRESET_VECTOR_ADDRESS=$(RESET_VEC) -fno-builtin -ffreestanding -nostdinc -isystem$(ISYSTEM) -pipe  -DCONFIG_PPC -D__powerpc__ -ffixed-r2 -Wa,-me500 -msoft-float -mno-string -mspe=yes -mno-spe -includeC:\u-boot-2009.11-cloud\include\u-boot\u-boot.lds.h -ansi -D__ASSEMBLY__ -P  - <C:\u-boot-2009.11-cloud\cpu\mpc85xx\wu-boot.lds > $(BASE_DIR)\u-boot.lds
...
# Ещё один путь
#C:\Program Files\Freescale\Cross_Tools\freescale-4.4\lib\gcc\powerpc-linux-gnu\4.4.1\te500v2 -lgcc -o u-boot
#В этом make удаляем ненужные файлы e1000.c  и e1000.0 !!!


#В дальнейшем должен делать мой парсер!!!!!
UNDEF_SYM = -u__u_boot_cmd_base -u__u_boot_cmd_bdinfo -u__u_boot_cmd_boot -u__u_boot_cmd_bootm -u__u_boot_cmd_cmp                      \
-u__u_boot_cmd_cp -u__u_boot_cmd_cpu -u__u_boot_cmd_echo -u__u_boot_cmd_editenv -u__u_boot_cmd_end -u__u_boot_cmd_erase                \
-u__u_boot_cmd_exit  -u__u_boot_cmd_flinfo  -u__u_boot_cmd_go -u__u_boot_cmd_help -u__u_boot_cmd_iminfo -u__u_boot_cmd_imls            \
-u__u_boot_cmd_itest -u__u_boot_cmd_loads -u__u_boot_cmd_loady -u__u_boot_cmd_loop -u__u_boot_cmd_mac -u__u_boot_cmd_md                \
...
#Расположение \drivers\pcmcia
LIBPCMCIA_DIR = C:\u-boot-2009.11-cloud\drivers\pcmcia
#Расположение \post\libpost
LIBPOST_DIR = C:\u-boot-2009.11-cloud\post

#Директории для qe.a ,ddr.a ,video.a
#LIBQE_DIR = C:\u-boot-2009.11-cloud\drivers\qe
#LIBDDR_DIR = C:\u-boot-2009.11-cloud\cpu\mpc8xxx\ddr
#LIBVIDEO_DIR = C:\u-boot-2009.11-cloud\drivers\video



#//////////////////////////////ALL Assembler Librari///////////////////////////////
LIBS = $(LIBGENERIC_DIR)\libgeneric.a $(LIBRDBCOMMON_DIR)\libfreescale.a $(MPC85xx_DIR)\libmpc85xx.a   \
$(LIBPPC_DIR)\libppc.a $(LIBFAT_DIR)\libfat.a  $(LIBEXT2_DIR)\libext2fs.a $(LIBNET_DIR)\libnet.a    \
$(LIBDISK_DIR)\libdisk.a $(LIBI2C_DIR)\libi2c.a  $(LIBMISC_DIR)\libmisc.a $(LIBMMC_DIR)\libmmc.a   \
$(LIBMTD_DIR)\libmtd.a  $(LIBNAND_DIR)\libnand.a  $(LIBSPI_DIR)\libspi_flash.a  $(LIBDRNET_DIR)\libnet.a  \
$(LIBPCI_DIR)\libpci.a  $(LIBPCMCIA_DIR)\libpcmcia.a  $(LIBFSLSPI_DIR)\libspi.a  $(LIBCPU8xxx_DIR)\lib8xxx.a  \
$(LIBRTC_DIR)\librtc.a  $(LIBSERIAL_DIR)\libserial.a  $(LIBUSB_DIR)\libusb_host.a  $(LIBCOMMON_DIR)\libcommon.a  \
$(LIBFDT_DIR)\libfdt.a  $(LIBPOST_DIR)\libpost.a   $(LIBP1P2RDB_DIR)\libp1_p2_rdb.a
...
SRC_LIBDRNET = $(LIBDRNET_DIR)\tsec.c   $(LIBDRNET_DIR)\vsc7385.c
...
#Файлы СИ для сборки библиотеки libpcmcia.a
SRC_LIBPCMCIA = $(LIBPCMCIA_DIR)\rpx_pcmcia.c  $(LIBPCMCIA_DIR)\tqm8xx_pcmcia.c

#Cкорее всего необязательно qe.a,ddr.a,libvideo.a   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#SRC_LIBQE = $(LIBQE_DIR)\fdt.c
#SRC_LIBDDR = $(LIBDDR_DIR)\main.c $(LIBDDR_DIR)\util.c  $(LIBDDR_DIR)\ctrl_regs.c               \
#$(LIBDDR_DIR)\options.c  $(LIBDDR_DIR)\lc_common_dimm_params.c  $(LIBDDR_DIR)\ddr2_dimm_params.c
#SRC_LIBVIDEO = $(LIBVIDEO_DIR)\videomodes.c
...
SRO_LIBDRNET = $(LIBDRNET_DIR)\tsec.o   $(LIBDRNET_DIR)\vsc7385.o
...
#Файлы СИ для сборки библиотеки libpcmcia.a
SRO_LIBPCMCIA = $(LIBPCMCIA_DIR)\rpx_pcmcia.o  $(LIBPCMCIA_DIR)\tqm8xx_pcmcia.o


#Cкорее всего необязательно qe.a,ddr.a,libvideo.a 
#SRO_LIBQE = $(LIBQE_DIR)\fdt.o
#SRO_LIBDDR = $(LIBDDR_DIR)\main.o $(LIBDDR_DIR)\util.o  $(LIBDDR_DIR)\ctrl_regs.o               \
#$(LIBDDR_DIR)\options.o  $(LIBDDR_DIR)\lc_common_dimm_params.o  $(LIBDDR_DIR)\ddr2_dimm_params.o
#SRO_LIBVIDEO = $(LIBVIDEO_DIR)\videomodes.o 




#Флаги для сборки u-boot
#UBOTT_FLAGS = -Bstatic -T  C:\u-boot-2009.11-cloud\u-boot.lds  -n -Ttext "0x11000000" $(UNDEF_SYM) C:\u-boot-2009.11-cloud\cpu\mpc85xx\start.o  C:\u-boot-2009.11-cloud\cpu\mpc85xx\resetvec.o --start-group $(LIBS) --end-group -LC:\Cross_Tools\freescale-4.4\lib\gcc\powerpc-linux-gnu\4.4.1\te500v2 -lgcc -Map u-boot.map -o u-boot
UBOTT_FLAGS = -Bstatic -T  C:\u-boot-2009.11-cloud\u-boot.lds  -n -Ttext "0x11000000" $(UNDEF_SYM) C:\u-boot-2009.11-cloud\cpu\mpc85xx\start.o  C:\u-boot-2009.11-cloud\cpu\mpc85xx\resetvec.o --start-group $(LIBS) --end-group -LC:\Cross_Tools\4.3.2 -lgcc -Map u-boot.map -o u-boot
#C:\Cross_Tools\4.3.2

#Цель              Реквизит
$(BASE_DIR)\u-boot:$(LIBS)
# Загрушка на время пока не разберусь почему такой глюк c этим start.o?????????????????????? 
		$(AS) -I$(INCDIR) $(DEFS) $(CPFLAGS) -o $(BASE_DIR)\start.o $(BASE_DIR)\start.c -c 
		$(LD) $(UBOTT_FLAGS)
		$(CP) -O srec $(BASE_DIR)\u-boot $(BASE_DIR)\u-boot.srec
		$(CP) --gap-fill=0xff -O binary $(BASE_DIR)\u-boot $(BASE_DIR)\u-boot.bin
...
# Cборка u-boot.lds нам пока не нужно это
# $(CC) -I$(INCDIR) $(UBOOT_LDSFLAGS)
		$(AS) -I$(INCDIR) $(DEFS) $(CPFLAGS) -o $(MPC85xx_DIR)\start.o $(MPC85xx_DIR)\start.S -c 
...
$(LIBPCMCIA_DIR)\libpcmcia.a:$(SRO_LIBPCMCIA)	
		$(AR) $(ARFLAGS) $(LIBPCMCIA_DIR)\libpcmcia.a $(SRO_LIBPCMCIA)		
$(SRO_LIBPCMCIA) : $(SRC_LIBPCMCIA)		
		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBPCMCIA_DIR)\rpx_pcmcia.o $(LIBPCMCIA_DIR)\rpx_pcmcia.c -c
		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBPCMCIA_DIR)\tqm8xx_pcmcia.o $(LIBPCMCIA_DIR)\tqm8xx_pcmcia.c -c
#Библиотеки которые я исключил но можно их добавить
#$(LIBQE_DIR)\qe.a:$(SRO_LIBQE)	
#		$(AR) $(ARFLAGS) $(LIBQE_DIR)\qe.a $(SRO_LIBQE)		
#$(SRO_LIBQE) : $(SRC_LIBQE)		
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBQE_DIR)\fdt.o $(LIBQE_DIR)\fdt.c -c
#$(LIBDDR_DIR)\libddr.a:$(SRO_LIBDDR)	
#		$(AR) $(ARFLAGS) $(LIBDDR_DIR)\libddr.a $(SRO_LIBDDR)		
#$(SRO_LIBDDR) : $(SRC_LIBDDR)		
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBDDR_DIR)\main.o $(LIBDDR_DIR)\main.c -c
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBDDR_DIR)\util.o $(LIBDDR_DIR)\util.c -c
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBDDR_DIR)\ctrl_regs.o $(LIBDDR_DIR)\ctrl_regs.c -c
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBDDR_DIR)\options.o $(LIBDDR_DIR)\options.c -c
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBDDR_DIR)\lc_common_dimm_params.o $(LIBDDR_DIR)\lc_common_dimm_params.c -c
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBDDR_DIR)\ddr2_dimm_params.o $(LIBDDR_DIR)\ddr2_dimm_params.c -c		
#$(LIBVIDEO_DIR)\libvideo.a:$(SRO_LIBVIDEO)	
#		$(AR) $(ARFLAGS) $(LIBVIDEO_DIR)\libvideo.a $(SRO_LIBVIDEO)		
#$(SRO_LIBVIDEO) : $(SRC_LIBVIDEO)		
#		$(CC) -I$(INCDIR) $(C_CPFLAGS) -o $(LIBVIDEO_DIR)\videomodes.o $(LIBVIDEO_DIR)\videomodes.c -c
