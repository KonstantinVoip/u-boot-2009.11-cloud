...
#else
//PORPLLSR Field Descriptions Здесь должно быть всё четко так как мы берём значение регистра 
//он должен нам возвратить в bin=111  или в hex 0x7	говорит нам что память в cинхронном режиме!!!!
