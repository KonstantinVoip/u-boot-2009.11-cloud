...
#define CONFIG_SYS_LBCR_ADDR (CONFIG_SYS_LBC_ADDR + 0xd0)
	...
	lis	r8, FSL_BOOKE_MAS2(CONFIG_SYS_CCSRBAR, (MAS2_I|MAS2_G))@h
	ori	r8, r8, FSL_BOOKE_MAS2(CONFIG_SYS_CCSRBAR, (MAS2_I|MAS2_G))@l

	lis	r9, FSL_BOOKE_MAS3(CONFIG_SYS_CCSRBAR, 0,
						(MAS3_SW|MAS3_SR))@h
	ori	r9, r9, FSL_BOOKE_MAS3(CONFIG_SYS_CCSRBAR, 0,
						(MAS3_SW|MAS3_SR))@l
	...
	/* NOR  Flash, localbus */
	lis	r6, FSL_BOOKE_MAS0(1, 2, 0)@h
	ori	r6, r6, FSL_BOOKE_MAS0(1, 2, 0)@l

	lis	r7, FSL_BOOKE_MAS1(1, 1, 0, 0, BOOKE_PAGESZ_16M)@h
	ori	r7, r7, FSL_BOOKE_MAS1(1, 1, 0, 0, BOOKE_PAGESZ_16M)@l

	lis	r8, FSL_BOOKE_MAS2(CONFIG_SYS_FLASH_BASE, (MAS2_I|MAS2_G))@h
	ori	r8, r8, FSL_BOOKE_MAS2(CONFIG_SYS_FLASH_BASE, (MAS2_I|MAS2_G))@l

	lis	r9, FSL_BOOKE_MAS3(CONFIG_SYS_FLASH_BASE, 0,
						(MAS3_SX|MAS3_SW|MAS3_SR))@h
	ori	r9, r9, FSL_BOOKE_MAS3(CONFIG_SYS_FLASH_BASE, 0,
						(MAS3_SX|MAS3_SW|MAS3_SR))@l
	...
	/* DDR SDRAM */
	lis	r6, FSL_BOOKE_MAS0(1, 7, 0)@h
	ori	r6, r6, FSL_BOOKE_MAS0(1, 7, 0)@l

	lis	r7, FSL_BOOKE_MAS1(1, 1, 0, 0, BOOKE_PAGESZ_1G)@h
	ori	r7, r7, FSL_BOOKE_MAS1(1, 1, 0, 0, BOOKE_PAGESZ_1G)@l

	lis	r8, FSL_BOOKE_MAS2(0, 0 )@h
	ori	r8, r8, FSL_BOOKE_MAS2(0, 0 )@l

	lis	r9, FSL_BOOKE_MAS3(0, 0, (MAS3_SX|MAS3_SW|MAS3_SR))@h
	ori	r9, r9, FSL_BOOKE_MAS3(0, 0, (MAS3_SX|MAS3_SW|MAS3_SR))@l
...
in_ram:
	GET_GOT
	bl	board_init_f
	bl	board_init_r		/* board specific init */
	isync
