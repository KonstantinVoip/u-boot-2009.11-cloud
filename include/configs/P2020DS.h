...
#define CONFIG_SATAPRODUCTBOOTCOMMAND		\
 "setenv bootargs root=/dev/$bdev rw "		\
 "console=$consoledev,$baudrate $othbootargs;"	\
...
#define CONFIG_BOOTCOMMAND		CONFIG_SATAPRODUCTBOOTCOMMAND
