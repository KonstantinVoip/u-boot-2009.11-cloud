 ...
 * P1020RDB, P1011RDB, P2020RDB and P2010RDB
 */
...
#define CONFIG_P2020
#endif
 /*У нас не определено в файле config.h */
 ...
 */
/*Определяет размещение в памяти для различных типов носителей NAND,NOR,RAM,SPI,eSDHC*/
#define CONFIG_SYS_FSL_BOOT_DDR

/*Пока надо разбираться зачем*/
#define CONFIG_HWCONFIG

/*Конфигурация нашей SPI_FLASH */
...
/*
 *  Конфигурация шины процессора eSPI - Enhanced SPI Конфигурация ESPI Шины
 */
...
//#define CONFIG_SF_DEFAULT_SPEED      10000000     /*10 Мгц */
//#define CONFIG_SF_DEFAULT_SPEED      20000000     /*20 Мгц */
// #define CONFIG_SF_DEFAULT_SPEED    33000000      /*33 Мгц */
    #define CONFIG_SF_DEFAULT_SPEED    66666666     /*66 Мгц */
 //#define CONFIG_SF_DEFAULT_SPEED     40000000     /*40 Мгц */

#define CONFIG_SF_DEFAULT_MODE 0



/*Конфигурация Памяти DDR  */
/*Если у нас будет синхронный режим должны убрать этот define CONFIG_DDR_CLK_FREQ*/
#define CONFIG_DDR_CLK_FREQ	66666666 /* DDRCLK on P1_P2 RDB */

/*Тестирование диапазона памяти когда загрузиться u-boot */
#define CONFIG_SYS_MEMTEST_START	0x00000000	/* memtest works on */
#define CONFIG_SYS_MEMTEST_END		0x1fffffff

/*Не определено у нас в файле config.h*/
...
/*#define CONFIG_FSL_SERDES	1*/	/* В новой плате не используеться Use common serdes init code */
...
/*Определяем многоядерную (Multicore processor)сборку*/
...
/* TSECV2 */
#if defined(CONFIG_P1020) || defined(CONFIG_P1011)
...
/*Разрешение на использование 36 битной адресации для увелечение адресного пространства */
...
/*#define CONFIG_SYS_SDRAM_SIZE   512*/  /*512 Mb*/
...
/*Возможно эти функции нам будут не нужны так тут иниицализации SD/MMC кототрой у нас нет */
#define CONFIG_BOARD_EARLY_INIT_R /* call board_early_init_r function */
#define CONFIG_SYS_INIT_RAM_LOCK	1

/*Инициализация I2C */
#ifdef CONFIG_I2C_U_BOOT
#define CONFIG_SYS_FLASH_UBOOT_OFFSET	0xf80000
...
#ifndef CONFIG_I2C_U_BOOT
#define CONFIG_SYS_NS16550_CLK		get_bus_freq(0)

//#define CONFIG_SERIAL_MULTI	1 /* Enable both serial ports */
#else
#define CONFIG_SYS_NS16550_CLK		600000000
#endif
...
/*Это важная вещь без неё не загружаеться LINUX в будущем разберусь!!!->>>>>>> CONFIG_OF_BOARD_SETUP */
#define CONFIG_OF_BOARD_SETUP	1
#define CONFIG_OF_STDOUT_VIA_ALIAS	1


/*64 Битный формат строки итд.. не знаю зачем он нам */
...
/* In Rev 1.0 of P1020, and Rev 2.0 of P2020 in the Host Capabilities register
 * the 1.8V bit is set; it should not be. So we exclude this
 * setting in the driver. Same issue as being observed in P1022
 */
...
#define CONFIG_ROOTPATH		/tftpboot/ltib
