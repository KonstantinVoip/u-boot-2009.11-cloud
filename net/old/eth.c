...
struct eth_device *eth_get_dev_by_index(int index)
{
	...
	do {
		 switch(idx)
	     {case 0:puts("????get Tsec1 eth_device_structure?????\n\r");break;
	      case 1:puts("????get Tsec2 eth_device_structure?????\n\r");break;
	      case 2:puts("????get Tsec3 eth_device_structure?????\n\r");break;
	      case 3:puts("????get Tsec4 eth_device_structure??????\n\r");break;
		  default:break;}
...
int eth_get_dev_index (void)
{
	...
	int num = 0;
	int i;
    //puts("+++++++++eth.c/eth_get_dev_index+++++++\n\r"); 
	if (!eth_devices) 
	{
		puts("-1 no eth device\n\r");
		return (-1);
	}
	...
	{
    	 switch(num)
	     {case 0:puts("????USE Tsec1 eth_device?????\n\r");break;
	      case 1:puts("????USE Tsec2 eth_device?????\n\r");break;
	      case 2:puts("????USE Tsec3 eth_device?????\n\r");break;
	      case 3:puts("????USE Tsec4 eth_device?????\n\r");break;
		  default:break;}
