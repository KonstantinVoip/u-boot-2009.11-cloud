...
#UBFLAGS  = -Bstatic -T u-boot.lds -n -Ttext "0x11000000" $UNDEF_SYM cpu/mpc85xx/start.o cpu/mpc85xx/resetvec.o --start-group  --end-group  -L/opt/freescale/usr/local/gcc-4.3.74-eglibc-2.8.74-dp-2/powerpc-none-linux-gnuspe/lib/gcc/powerpc-none-linux-gnuspe/4.3.2 -lgcc -Map u-boot.map -o u-boot 


#Цель              Реквизит
$(BASE_DIR)\mu-boot.a:$(LIBS)
		$(AR) $(ARFLAGS) $(BASE_DIR)\mu-boot.a $(LIBS)
