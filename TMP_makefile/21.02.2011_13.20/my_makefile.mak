...
SRC_LIBPPC = $(LIBPPC_DIR)\ppccache.c    
#$(LIBPPC_DIR)\ppcstring.c  $(LIBPPC_DIR)\ticks.c  $(LIBPPC_DIR)\bat_rw.c     \ 
#$(LIBPPC_DIR)\board.c  $(LIBPPC_DIR)\bootm.c  $(LIBPPC_DIR)\cache.c          \
#$(LIBPPC_DIR)\extable.c $(LIBPPC_DIR)\interrupts.c $(LIBPPC_DIR)\time.c      \
...
SRO_LIBPPC = $(LIBPPC_DIR)\ppccache.o  
#$(LIBPPC_DIR)\ppcstring.o  $(LIBPPC_DIR)\ticks.o   $(LIBPPC_DIR)\bat_rw.o     \  
#$(LIBPPC_DIR)\board.o  $(LIBPPC_DIR)\bootm.o  $(LIBPPC_DIR)\cache.o           \
#$(LIBPPC_DIR)\extable.o $(LIBPPC_DIR)\interrupts.o  $(LIBPPC_DIR)\time.o      \
...
all:$(MPC85xx_DIR)\libmpc85xx.a  $(LIBPPC_DIR)\libppc.a
