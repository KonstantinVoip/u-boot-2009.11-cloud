...
{
	puts ("I2C:   ");
	i2c_init (CONFIG_SYS_I2C_SPEED, CONFIG_SYS_I2C_SLAVE); //comment 11.05.2012
	puts ("ready\n");
	return (0);
}
#endif
...
void board_init_f (ulong bootflag)
{
	...
	*s-- = 0;
    ...
    printf ("Relocate  is:addr_sp= %08lx ,id=%08lx,addr=%08lx\n", addr_sp,id,addr);
...
//#else
    ...
    //puts ("Now running in RAM - U-Boot at: %08lx\n\n");
//#endif
...
printf("\tCS1\tBR1\t0x%08X\tOR1\t0x%08X \n", lbc->br1, lbc->or1);
...
//	mac_read_from_eeprom();
    ...
    //puts ("++++++++++++++!bd->bi_ip_addr = getenv_IPaddr+++++++++++++++++++++ ");
    //putc ('\n');
	WATCHDOG_RESET ();
